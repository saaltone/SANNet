...
public class Node implements Serializable {
     ...
     */
    public Node(int id, Matrix referenceMatrix, boolean isConstantNode) throws MatrixException {
     ...
     * @throws MatrixException throws exception is matrix is not defined.
     */
    public Node(int id, MMatrix referenceMatrix, boolean isConstantNode) throws MatrixException {
