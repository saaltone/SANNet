...
public class ConvolutionMatrixOperation extends AbstractConvolutionMatrixOperation {
     ...
     */
    public ConvolutionMatrixOperation(int rows, int columns, int depth, int inputDepth, int filterRowSize, int filterColumnSize, int dilation, int stride, boolean isDepthSeparable) {
