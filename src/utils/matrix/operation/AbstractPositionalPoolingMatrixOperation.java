...
public abstract class AbstractPositionalPoolingMatrixOperation extends AbstractMatrixOperation {
     ...
     */
    public AbstractPositionalPoolingMatrixOperation(int rows, int columns, int depth, int inputRowSize, int inputColumnSize, int filterRowSize, int filterColumnSize, int stride) {
