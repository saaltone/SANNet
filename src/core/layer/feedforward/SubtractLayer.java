 ...
 *
 */
public class SubtractLayer extends AbstractExecutionLayer {
     ...
     */
    public SubtractLayer(int layerIndex, Initialization initialization, String params) throws NeuralNetworkException, DynamicParamException {
    ...
    public MMatrix getForwardProcedure() throws MatrixException {
        ...
        for (MMatrix mMatrix : inputs.values()) {
            output = output == null ? mMatrix.get(0) : output.subtract(mMatrix.get(0));
        }
