 ...
 *
 */
public class DotLayer extends AbstractExecutionLayer {
     ...
     */
    public DotLayer(int layerIndex, Initialization initialization, String params) throws NeuralNetworkException, DynamicParamException {
    ...
    public MMatrix getForwardProcedure() throws MatrixException {
        ...
        for (MMatrix mMatrix : inputs.values()) {
            output = output == null ? mMatrix.get(0) : output.dot(mMatrix.get(0));
        }
