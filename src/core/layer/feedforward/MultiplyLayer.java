...
public class MultiplyLayer extends AbstractExecutionLayer {
     ...
     */
    public MultiplyLayer(int layerIndex, Initialization initialization, String params) throws NeuralNetworkException, DynamicParamException {
    ...
    public MMatrix getForwardProcedure() throws MatrixException {
        ...
        for (MMatrix mMatrix : inputs.values()) {
            output = output == null ? mMatrix.get(0) : output.multiply(mMatrix.get(0));
        }
