...
public class L1_Regularization extends AbstractRegularizationLayer {
    ...
    /**
     * Returns parameters used for L1 regularization layer.
     *
     * @return parameters used for L1 regularization layer.
     */
    public String getParamDefs() {
        return super.getParamDefs() + ", " + L1_Regularization.paramNameTypes;
    }
    ...
    protected void defineProcedure() throws NeuralNetworkException {
        if (!(getNextLayer() instanceof OutputLayer)) throw new NeuralNetworkException("L1 Regularization must be final layer prior output layer.");
