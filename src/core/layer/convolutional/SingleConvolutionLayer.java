...
public class SingleConvolutionLayer extends AbstractSingleConvolutionalLayer {
    ...
    /**
     * Returns parameters used for single convolution layer.
     *
     * @return parameters used for single convolution layer.
     */
    public String getParamDefs() {
        return super.getParamDefs() + ", " + SingleConvolutionLayer.paramNameTypes;
    }

    /**
     * Sets parameters used for single convolution layer.<br>
     * <br>
     ...
     *     - dilation: dilation step for filter. Default step 1.<br>
     *
     * @param params parameters used for single convolution layer.
     * @throws DynamicParamException throws exception if parameter (params) setting fails.
