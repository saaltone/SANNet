...
public class ConvolutionLayer extends AbstractConvolutionalLayer {
    ...
    /**
     * Parameter name types for ConvolutionLayer.
     ...
     */
    public ConvolutionLayer(int layerIndex, ActivationFunction activationFunction, Initialization initialization, String params) throws DynamicParamException, NeuralNetworkException, MatrixException {
    ...
    /**
     * Sets parameters used for ConvolutionLayer.<br>
     * <br>
