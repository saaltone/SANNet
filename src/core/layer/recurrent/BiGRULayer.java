...
/**
 * Implements bidirectional gated recurrent unit (GRU) layer.<br>
 * <br>
...
public class BiGRULayer extends GRULayer {
     ...
     * @throws MatrixException throws exception if custom function is attempted to be created with this constructor.
     */
    public BiGRULayer(int layerIndex, ActivationFunction activationFunction, Initialization initialization, String params) throws NeuralNetworkException, DynamicParamException, MatrixException {
        super (layerIndex, initialization, params);
    }
    ...
    public void initializeWeights() {
        ...
        reverseWeightSet = new GRUWeightSet(initialization, getPreviousLayerWidth(), super.getLayerWidth(), getRegulateDirectWeights(), getRegulateRecurrentWeights());
    }
