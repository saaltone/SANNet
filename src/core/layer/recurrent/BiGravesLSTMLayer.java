...
public class BiGravesLSTMLayer extends GravesLSTMLayer {
    ...
    public void initializeWeights() {
        ...
        reverseWeightSet = new GravesLSTMWeightSet(initialization, getPreviousLayerWidth(), super.getLayerWidth(), getRegulateDirectWeights(), getRegulateRecurrentWeights());
    }
