 ...
 *
 */
public class DDQNLearningAbstract extends AbstractQLearning {
     ...
     */
    public DDQNLearningAbstract(Environment environment, ActionablePolicy policy, Buffer buffer, QTargetValueFunctionEstimator qTargetValueFunctionEstimator) {
     ...
     */
    public DDQNLearningAbstract(Environment environment, ActionablePolicy policy, Buffer buffer, QTargetValueFunctionEstimator qTargetValueFunctionEstimator, String params) throws DynamicParamException {
