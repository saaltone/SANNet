 ...
 *
 */
public class DQNLearningAbstract extends AbstractQLearning {
     ...
     */
    public DQNLearningAbstract(Environment environment, ActionablePolicy policy, Buffer buffer, QValueFunctionEstimator qValueFunctionEstimator) {
     ...
     */
    public DQNLearningAbstract(Environment environment, ActionablePolicy policy, Buffer buffer, QValueFunctionEstimator qValueFunctionEstimator, String params) throws DynamicParamException {
